...
def getid(keyword,cookies,r18=False,leastpages=100,leastlikes=1000):
    baseurl = R18('http://www.pixiv.net/search.php?word=' + keywordSwicher(keyword),r18)
    dataids = []
    for i in range(leastpages):
